    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 p-4 rounded-2xl w-[223px] bg-white shadow-lg border border-gray-200 z-50 overflow-hidden">
          {/* User Info Section */}
          <h4 className="font-rubik font-semibold text-lg !text-[#232321]">Admin</h4>
          ...
          <button className="flex items-center cursor-pointer font-rubik font-medium text-sm text-[#232321] mt-6 text-nowrap">LOGOUT<IoIosLogOut size={20} className="ms-10" /></button>
        </div>
      )}
    </div>
  );
